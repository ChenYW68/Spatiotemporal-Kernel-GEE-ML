...
## Software package
We developed an R package to implement the proposed K-nearest-neighbor weighted local linear regression (KNN-WLLR) in `knnWLLR`; see [`knnWLLR_1.0.zip`](./LoadPackages/knnWLLR_1.0.zip). All simulation code can be found in the code folder to facilitate reproducibility.
